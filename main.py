...
jugadores.append({ "nombre" : "Ana" , "tts" : mixer.Sound('assets/sonidos/nombres/Ana.wav') } )
...
jugadores.append({ "nombre" : "David" , "tts" : mixer.Sound('assets/sonidos/nombres/David.wav') } )
jugadores.append({ "nombre" : "Diego" , "tts" : mixer.Sound('assets/sonidos/nombres/Diego.wav') } )
jugadores.append({ "nombre" : "Elvy" , "tts" : mixer.Sound('assets/sonidos/nombres/Elvy.wav') } )
...
jugadores.append({ "nombre" : "Miguel" , "tts" : mixer.Sound('assets/sonidos/nombres/Miguel.wav') } )
...
jugadores.append({ "nombre" : "Raisa" , "tts" : mixer.Sound('assets/sonidos/nombres/Raisa.wav') } )
...
#jugadores.append({ "nombre" : "Toto" , "tts" : mixer.Sound('assets/sonidos/nombres/Toto.wav') } )
...
jugadores.append({ "nombre" : "Jenny" , "tts" : mixer.Sound('assets/sonidos/nombres/Jenny.wav') } )
